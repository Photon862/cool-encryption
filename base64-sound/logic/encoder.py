...
Encodes base64 string character-by-character (one sound per character).
"""
...
class Encoder:
    """Encode text messages into WAV files (via base64)."""
    ...
    def encode(self, message, output_file=None):
        ...
        Args:
            message: String to encode (will be converted to base64)
